...
_GETSERVICESHEALTHSTATUSREQUEST = _descriptor.Descriptor(
  ...
  full_name='metisfl.GetServicesHealthStatusRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
...
_GETSERVICESHEALTHSTATUSRESPONSE_SERVICESSTATUSENTRY = _descriptor.Descriptor(
  ...
  full_name='metisfl.GetServicesHealthStatusResponse.ServicesStatusEntry',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='key', full_name='metisfl.GetServicesHealthStatusResponse.ServicesStatusEntry.key', index=0,
    ...
    _descriptor.FieldDescriptor(
      name='value', full_name='metisfl.GetServicesHealthStatusResponse.ServicesStatusEntry.value', index=1,
...
_GETSERVICESHEALTHSTATUSRESPONSE = _descriptor.Descriptor(
  ...
  full_name='metisfl.GetServicesHealthStatusResponse',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
  fields=[
    _descriptor.FieldDescriptor(
      name='services_status', full_name='metisfl.GetServicesHealthStatusResponse.services_status', index=0,
...
_SHUTDOWNREQUEST = _descriptor.Descriptor(
  ...
  full_name='metisfl.ShutDownRequest',
  filename=None,
  file=DESCRIPTOR,
  containing_type=None,
  create_key=_descriptor._internal_create_key,
